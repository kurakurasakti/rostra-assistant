...
export default function ImportPage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-2xl mx-auto space-y-6 animate-enter">
      <div>
      ...
      {/* Step 2: Mapping */}
      {step === "mapping" && (
        <div className="rounded-xl border border-border bg-card p-5 space-y-5 animate-enter">
          <div>
            <h2 className="font-display font-semibold text-sm">Mapping Kolom</h2>
            <p className="text-xs text-muted-foreground mt-0.5">
              Pilih kolom dari &quot;{fileName}&quot; yang sesuai tiap field.
            </p>
          </div>
      ...
      {step === "confirm" && result && (
        <div className="rounded-xl border border-border bg-card p-5 space-y-5 animate-enter">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-display font-semibold text-sm">Import Selesai</h2>
              <p className="text-xs text-muted-foreground mt-0.5">
                Proses import dari &quot;{fileName}&quot; selesai.
              </p>
            </div>
          </div>
