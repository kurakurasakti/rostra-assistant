    ...
    <div className="space-y-5">
      ...
      {step === "upload" && (
        ...
        >
          ...
          />
          <Button size="sm" type="button" onClick={e => { e.stopPropagation(); fileInputRef.current?.click() }}>
      ...
      {step === "mapping" && (
        <div className="space-y-4 animate-enter">
          ...
          <div className="flex gap-2 justify-end pt-1 border-t border-border">
            <Button variant="outline" size="sm" onClick={reset}>Ganti File</Button>
      ...
      {step === "confirm" && result && (
        <div className="space-y-4 animate-enter">
          ...
          <div className="flex gap-2 pt-1 border-t border-border">
            <Button variant="outline" size="sm" onClick={reset}>Import Lagi</Button>
            {result.imported > 0 && (
              <Link href="/clients">
                <Button size="sm">
